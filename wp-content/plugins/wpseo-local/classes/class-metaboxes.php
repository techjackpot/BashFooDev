	...
	class WPSEO_Local_Metaboxes {
		...
		function enqueue_scripts() {
			...
			if ( 'wpseo_locations' == get_post_type() ) {
				wp_enqueue_script( 'wp-seo-local-seo-locations', plugins_url( '../js/wp-seo-local-analysis-locations-510' . WPSEO_CSSJS_SUFFIX . '.js', __FILE__ ), array(), WPSEO_VERSION, true );
