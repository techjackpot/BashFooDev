	...
	class WPSEO_Local_Admin {
		...
		function register_settings_page( $submenu_pages ) {
			$submenu_pages[] = array(
				...
				'Yoast SEO: Local SEO',
				'Local SEO',
				apply_filters( 'wpseo_manage_options_capability', 'manage_options' ),
				'wpseo_local',
		...
		function config_page_scripts() {
			...
			wp_enqueue_script( 'wpseo-local-global-script', plugins_url( '../js/wp-seo-local-global-470' . $js_ext, dirname( __FILE__ ) ), array( 'jquery' ), WPSEO_LOCAL_VERSION, true );
