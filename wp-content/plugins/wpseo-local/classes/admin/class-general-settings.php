...
if ( ! class_exists( 'WPSEO_Local_Admin_General_Settings' ) ) {
	...
	class WPSEO_Local_Admin_General_Settings {
		...
		public function opening_hours() {
			WPSEO_Local_Admin_Page::section_before( 'opening-hours-container', 'clear: both; ' . ( ! wpseo_has_multiple_locations() ? '' : 'display: none;' ) );
			...
			WPSEO_Local_Admin_Page::section_before( 'opening-hours-inner', 'clear: both; display:' . ( ( true == $hide_opening_hours ) ? 'none' : 'block' ) . ';' );
